...
CREATE TABLE IF NOT EXISTS `nuky`.`article` (
  `id` BIGINT(16) UNSIGNED ZEROFILL NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nuky`.`comment` (
  `id` BIGINT(16) ZEROFILL UNSIGNED NOT NULL,
  `content` VARCHAR(1000) NOT NULL,
  `article_id` BIGINT(16) UNSIGNED NULL,
  `user_id` INT(8) UNSIGNED NULL,
  `reply_comment_id` BIGINT(16) NULL,
  PRIMARY KEY (`id`),
